...
void Endstops::update() {
  ...
  #if ENABLED(G38_PROBE_TARGET) && PIN_EXISTS(Z_MIN_PROBE) && NONE(CORE_IS_XY, CORE_IS_XZ, HYBRID_E ,MARKFORGED_XY)
  ...
  #if ANY(CORE_IS_XY, CORE_IS_XZ, HYBRID_E, MARKFORGED_XY)
    #define X_AXIS_HEAD X_HEAD
  #else
    #define X_AXIS_HEAD X_AXIS
  #endif
  #if ANY(CORE_IS_XY, CORE_IS_YZ, HYBRID_E, MARKFORGED_XY)
  ...
  bool Endstops::tmc_spi_homing_check() {
    bool hit = false;
      ...
      if (tmc_spi_homing.x && (stepperX.test_stall_status()
        #if ANY(CORE_IS_XY, HYBRID_E, MARKFORGED_XY) && Y_SPI_SENSORLESS
      ...
      if (tmc_spi_homing.y && (stepperY.test_stall_status()
        #if ANY(CORE_IS_XY, HYBRID_E, MARKFORGED_XY) && X_SPI_SENSORLESS
